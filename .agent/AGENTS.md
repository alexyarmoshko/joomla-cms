...
This repo contains Joomla 5.4.1 code. Use the Joomla API and conventions; avoid ad-hoc PHP unless there is no core helper. Ignore "./.*" folders with subfolders as they are not relevant to understand the project.
